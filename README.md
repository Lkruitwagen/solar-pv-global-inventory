...
In order to mitigate climate change and alleviate global poverty, energy system projections show a nearly ten-fold increase in solar photovoltaic (PV) electricity generating capacity by 2040.<sup>[1](https://webstore.iea.org/world-energy-outlook-2019)</sup> Understanding the spatially-distributed energy system is necessary to manage generation intermittency, climate risks, and associated social impacts. Here, we provide a global inventory of utility-scale solar PV generation stations using a longitudinal corpus of remote sensing imagery, machine learning, and a large cloud computation infrastructure. We search 550TB of imagery to locate and verify 68,661 facilities with a cumulative estimated power output of approximately 280 GW, an increase of 166\% on the previously best-available asset-level data for solar PV. We enrich our dataset with estimates of facility installation date and historic land cover classification. Our land cover analysis shows that solar PV development skews towards agricultural areas but developers favour barren and grassland sites within these areas.  As international climate policy efforts turn towards assessing progress and debating monitoring mechanisms, this analysis demonstrates the potential for remote sensing to provide climate-relevant data that is unaffected by biases in reporting from companies and countries.  Fundamental datasets such as this inventory are crucial for the operation of increasingly renewables-based electricity systems, and for the design, implementation, and validation of effective policy regimes and markets to deliver the diffusion of solar PV generation aligned with the UN sustainable development goals and a 1.5&deg;C constraint to anthropogenic climate change. We make our dataset publicly available to facilitate more research of this type, and to jump-start the availability of a globally exhaustive, feature-rich, and publicly available solar PV asset-level data.
