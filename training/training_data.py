...
class MakeTrainingData:
    ...
    def __init__(self):
        ...
        self.trn_dltiles = json.load(open(exists_or_download('training/data/all_trn_dltiles.geojson'),'r'))['features']
        self.trn_polygons = json.load(open(exists_or_download('training/data/all_trn_polygons.geojson'),'r'))['features']
...
if __name__ == "__main__":
    ...
    trn_data = MakeTrainingData()
    for ii_t, tt in enumerate(trn_data.trn_dltiles[0:12]):
